...
class _ProductDetailssState extends State<ProductDetailss> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.model.prodName),
      ),
      body: Column(
        children: <Widget>[
          Expanded(
      ...
      child: Row(
        children: <Widget>[
          Expanded(child: Container(
            child: FlatButton(onPressed: null, child: Text("ADD TO CART", style: TextStyle(color: Colors.black),)),
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(8),
              gradient: LinearGradient(
                colors: [Color(0xffffcb2b), Color(0xfffcee21), Color(0xffd9e021)],
...
//  }
    ...
    return Container(
      ...
      child: GridTile(
        ...
        footer: Container(
          color: Colors.white,
          child: ListTile(
            leading: Text(widget.model.prodName,
                overflow: TextOverflow.ellipsis,
                maxLines: 1,
            ...
            title: Row(
              children: <Widget>[
                ...
                Expanded(
                  child: Text("\$${widget.model.prodPrice}",
                      overflow: TextOverflow.ellipsis,
                      maxLines: 1,
                      style: TextStyle(
  ...
  Widget buildDescription() {
    return ListTile(
      title: Text("${widget.model.prodName} Details"),
      subtitle: Text(
